...
local colors = {
  ...
  cyan = aqua.soft,
  white = white,
  bright_black = gray.darker,
  bright_red = red.normal,
  bright_green = green.normal,
  bright_yellow = yellow.normal,
  bright_blue = blue.normal,
  bright_magenta = purple.normal,
  bright_cyan = aqua.normal,
  bright_white = gray.lightestest,
  dim_black = gray.darkestest,
  dim_red = red.dark,
  dim_green = green.dark,
  dim_yellow = yellow.dark,
  dim_blue = blue.dark,
