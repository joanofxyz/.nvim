...
return {
	...
	lush = lush(function(injected_functions)
		...
		return {
			...
			Search {bg = yellow.soft, fg = gray.darker},
			AerialLine {Search},
			...
			Visual {bg = gray.darkestest},
			VisualNOS {Visual},
			WarningMsg {fg = yellow.soft},
			Folded {bg = gray.darkestest, fg = gray.normal},
			FoldColumn {fg = gray.normal},
			CursorLineFold {FoldColumn},
			DiffAdd {bg = green.dark, fg = gray.darker},
			DiffChange {bg = blue.dark, fg = gray.darker},
			DiffDelete {bg = red.dark, fg = gray.darker},
			DiffText {bg = aqua.dark, fg = gray.darker},
			...
			SpellBad {gui = "undercurl", sp = red.bright},
			SpellCap {gui = "undercurl", sp = yellow.bright},
			SpellRare {gui = "undercurl", sp = blue.bright},
			SpellLocal {gui = "undercurl", sp = blue.bright},
			Pmenu {bg = gray.darkestest, fg = gray.light},
			WildMenu {Pmenu},
			PmenuKind {Pmenu},
			PmenuExtra {Pmenu},
			PmenuSbar {Pmenu},
			PmenuSel {bg = yellow.bright},
			...
			RedrawDebugRecompose {bg = red.normal, fg = gray.darker},
			Error {fg = red.soft},
			NvimInvalid {Error},
			sym "@error" {Error},
			luaParenError {Error},
			...
			DiagnosticUnderlineError {gui = "undercurl", sp = red.bright},
			DiagnosticUnderlineWarn {gui = "undercurl", sp = yellow.bright},
			DiagnosticUnderlineInfo {gui = "undercurl", sp = blue.bright},
			DiagnosticUnderlineHint {gui = "undercurl", sp = green.bright},
			DiagnosticUnderlineOk {gui = "underline", sp = green.normal},
			DiagnosticVirtualTextError {bg = red.soft, fg = red.bright},
			DiagnosticVirtualTextWarn {bg = yellow.soft, fg = yellow.bright},
			DiagnosticVirtualTextInfo {bg = blue.soft, fg = blue.bright},
			DiagnosticVirtualTextHint {bg = green.soft, fg = green.bright},
			DiagnosticDeprecated {gui = "strikethrough", sp = red.soft},
			Comment {fg = gray.dark},
			...
			Ignore {fg = black},
			NvimInternalError {bg = red.bright, fg = black},
			...
			NeogitDiffDeleteHighlight {bg = red.dark, fg = gray.darker},
			...
			ModesInsert {bg = aqua.soft, fg = gray.darker},
			ModesCopy {bg = yellow.soft, fg = gray.darker},
			...
			GitSignsVirtLnum {},
			TodoBgHACK {gui = "bold", bg = yellow.soft, fg = gray.darker},
			TodoFgHACK {fg = yellow.soft},
			TodoSignHACK {fg = yellow.soft},
			TodoBgTEST {gui = "bold", bg = yellow.soft, fg = gray.darker},
			TodoFgTEST {fg = yellow.soft},
			TodoSignTEST {fg = yellow.soft},
			TodoBgTODO {gui = "bold", bg = blue.soft, fg = gray.darker},
			TodoFgTODO {fg = blue.soft},
			TodoSignTODO {fg = blue.soft},
			TodoBgPERF {gui = "bold", bg = yellow.soft, fg = gray.darker},
			TodoFgPERF {fg = yellow.soft},
			TodoSignPERF {fg = yellow.soft},
			TodoBgWARN {gui = "bold", bg = yellow.soft, fg = gray.darker},
			TodoFgWARN {fg = yellow.soft},
			TodoSignWARN {fg = yellow.soft},
			TodoBgNOTE {gui = "bold", bg = green.soft, fg = gray.darker},
			TodoFgNOTE {fg = green.soft},
			TodoSignNOTE {fg = green.soft},
			TodoBgFIX {gui = "bold", bg = red.soft, fg = gray.darker},
